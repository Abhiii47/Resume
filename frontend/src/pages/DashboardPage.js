      ...
      {activeView === 'discover' && (
        <div className="flex-1 overflow-y-auto">
          ...
          {jobsLoading ? (
            ...
            <div className="text-center font-bold py-12" style={{ color: '#444', background: '#fdfbf7', border: '1px solid #000', boxShadow: '4px 4px 0 #000' }}>No jobs found — try a different role</div>
          ) : (
        ...
        >
          <div className="w-full max-w-2xl max-h-[85vh] overflow-y-auto p-6" style={{ background: '#fdfbf7', border: '2px solid #222', boxShadow: '8px 8px 0 hsl(24,100%,50%)' }}>
            <div className="flex justify-between items-start mb-5" style={{ borderBottom: '1px solid #000', paddingBottom: '1rem' }}>
              ...
              <button onClick={() => { setMatchModal(null); setMatchResult(null); }} className="text-xs font-black uppercase px-3 py-1.5" style={{ color: 'var(--muted-foreground)', border: '1px solid #000', boxShadow: '4px 4px 0 #000' }}>✕ Close</button>
            </div>
